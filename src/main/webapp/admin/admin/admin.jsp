	...
	<section class="content">
		<div class="card">
			<div class="card-header">
				<h3 class="card-title">
					<a
						href="<%out.print(request.getContextPath() + "/admin/account/create");%>"
					...
					<tbody>
						 <c:forEach items="${ admins }" var="adm">
						 	<tr>
						 		...
						 		<td>${ adm.email }</td>
						 		<td class="text-right">
						 			<a href="<%out.print(request.getContextPath() + "/admin/account/update");%>?id=${adm.id}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
						 			<a href="<%out.print(request.getContextPath() + "/admin/account/delete");%>?id=${adm.id}" class="btn btn-danger btn-del"><i class="fa fa-trash"></i></a>
						 		</td>
						 	</tr>
						 </c:forEach>
					</tbody>
