	...
	<section class="content">
		<div class="card">
			<div class="card-header">
				<h3 class="card-title">Cập nhật thông tin Lớp học</h3>
			...
			<div class="card-body">
				<form
					action="<%out.print(request.getContextPath() + "/admin/classroom/update");%>"
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleFormControlInput1">Tên Lớp học</label> <input
									...
									placeholder="Tên lớp học" value="${ classroom.className }">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleFormControlSelect1">Trạng thái</label> <select
									...
									<option value="0" ${ classroom.status == 0 ? "selected" : "" }>Ẩn</option>
									<option value="1" ${ classroom.status == 1 ? "selected" : "" }>Hiển thị</option>
								</select>
							</div>
						</div>
